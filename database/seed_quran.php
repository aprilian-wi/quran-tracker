<?php
// database/seed_quran.php
// Full Quran Structure Seeder (30 Juz, 114 Surahs)
// Run once: php database/seed_quran.php
...
if ($stmt->fetchColumn() > 0) {
    echo "Quran data already seeded.\n";
    exit;
}
...
echo "Successfully seeded $inserted surahs into quran_structure.\n";
echo "Total verses in Quran: 6236\n";