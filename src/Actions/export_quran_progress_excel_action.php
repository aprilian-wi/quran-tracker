<?php
// src/Actions/export_quran_progress_excel_action.php
global $pdo;
require_once __DIR__ . '/../Helpers/functions.php';
require_once __DIR__ . '/../Models/Progress.php';
require_once __DIR__ . '/../Models/Child.php';

// Check if teacher, school_admin or superadmin
...
header('Content-Disposition: attachment; filename="quran_progress_' . $child['name'] . '_' . date('Y-m-d') . '.csv"');
...
foreach ($history as $entry) {
    ...
    fputcsv($output, [
        ...
        $entry['surah_name_ar'] . ' (' . $entry['surah_name_en'] . ')',
        $entry['verse'],
        $statusText,
        $entry['note'] ?? '',
