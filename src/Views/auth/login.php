    ...
    <div class="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-100 slide-up">
        ...
        <div class="bg-emerald-600 p-8 text-center relative overflow-hidden">
            ...
            <div class="relative z-10">
                <div class="bg-white/20 w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-4 backdrop-blur-sm shadow-inner ring-4 ring-white/10">
                   <img src="<?= BASE_URL ?>public/assets/logo_quran_tracker.png" alt="Logo" class="w-20 h-20 object-contain drop-shadow-md">
                </div>
        ...
        <div class="p-8">
            ...
            <form method="POST" action="<?= BASE_URL ?>public/index.php?page=login" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative group">
                        <span class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400 group-focus-within:text-emerald-500 transition-colors">
                            <span class="material-icons-round text-xl">email</span>
                        </span>
            ...
            <div class="mt-8 text-center">
                 <p class="text-xs text-slate-400 font-medium tracking-wide">© <?= date('Y') ?> Quran Tracker. All rights reserved.</p>
            </div>
        </div>
    </div>
