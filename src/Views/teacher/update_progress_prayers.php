    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <?php foreach ($children as $child): ?>
            <div
                ...
                <div
                    class="w-16 h-16 rounded-full bg-emerald-50 dark:bg-emerald-900/40 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mb-4 text-2xl font-bold uppercase">
                ...
                <a href="?page=teacher/update_progress_prayers&child_id=<?= $child['id'] ?>"
                    class="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-emerald-600 hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-colors">
                    Perbarui Doa
                </a>
            </div>
        <?php endforeach; ?>
    ...
    <div class="p-6">
        <form method="POST" action="<?= BASE_URL ?>public/index.php?page=update_progress_prayers" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="prayer_id"
                        class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Pilih Doa</label>
                    <select name="prayer_id" id="prayer_id" required
            ...
            <div>
                ...
                <textarea name="note" id="note" rows="3" placeholder="Tambahkan catatan untuk progres ini..."
                    class="block w-full rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-900 dark:text-white shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm"></textarea>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <select id="statusFilter"
                        class="rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-sm text-slate-700 dark:text-slate-300 focus:ring-emerald-500 focus:border-emerald-500">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <select id="updatedByFilter"
                        class="rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-sm text-slate-700 dark:text-slate-300 focus:ring-emerald-500 focus:border-emerald-500 max-w-[150px]">
                        <option value="">Semua</option>
                        ...
                        <tr class="history-item hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500 dark:text-slate-400">
                                <?php if ($_SESSION['role'] === 'teacher'): ?>
                                    <form method="POST" action="<?= BASE_URL ?>public/index.php?page=delete_progress_prayers_action"
