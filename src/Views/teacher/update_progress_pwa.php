<?php
// src/Views/teacher/update_progress_pwa.php
...
<section class="pb-20">
    ...
    <form method="POST" action="<?= BASE_URL ?>public/index.php?page=update_progress"
        ...
        <input type="hidden" name="redirect_to" value="teacher/update_progress">
        ...
        <button type="submit"
            class="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3.5 px-4 rounded-xl shadow-lg shadow-emerald-900/20 active:scale-95 transition-all flex items-center justify-center gap-2">
                        ...
                        <div class="flex justify-between items-start mb-2 pl-2">
                            <div>
                                <div class="flex items-center gap-2">
                                    <h4 class="font-bold text-gray-900 dark:text-white"><?= h($entry['surah_name_ar']) ?>
                                        (<?= h($entry['surah_name_en']) ?>)</h4>
                                </div>
                                <p class="text-sm text-text-sub-light dark:text-text-sub-dark mt-0.5">Ayat
                                    <?= $entry['verse'] ?>
                                </p>
                            </div>
