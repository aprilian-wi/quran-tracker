    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <?php foreach ($children as $child): ?>
            <div
                ...
                <div
                    class="w-16 h-16 rounded-full bg-orange-50 dark:bg-orange-900/40 text-orange-600 dark:text-orange-400 flex items-center justify-center mb-4 text-2xl font-bold uppercase">
                ...
                <a href="?page=teacher/update_progress_hadiths&child_id=<?= $child['id'] ?>"
    ...
    <div class="p-6">
        <form method="POST" action="<?= BASE_URL ?>public/index.php?page=update_progress_hadiths" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="hadith_id"
                        class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Pilih Hadits</label>
                    <select name="hadith_id" id="hadith_id" required
                        class="block w-full rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-900 dark:text-white shadow-sm focus:border-orange-500 focus:ring-orange-500 sm:text-sm">
            ...
            <!-- Note -->
            <div>
                <label for="note" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Catatan
                    (Opsional)</label>
                <textarea name="note" id="note" rows="3" placeholder="Tambahkan catatan untuk progres ini..."
                    class="block w-full rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-900 dark:text-white shadow-sm focus:border-orange-500 focus:ring-orange-500 sm:text-sm"></textarea>
            </div>

            <!-- Submit Button -->
            <div class="flex items-center justify-end pt-4 border-t border-slate-200 dark:border-slate-700">
                <button type="submit"
                    class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-colors">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <select id="statusFilter"
                        class="rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-sm text-slate-700 dark:text-slate-300 focus:ring-orange-500 focus:border-orange-500">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <select id="updatedByFilter"
                        class="rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-sm text-slate-700 dark:text-slate-300 focus:ring-orange-500 focus:border-orange-500 max-w-[150px]">
                        <option value="">Semua</option>
