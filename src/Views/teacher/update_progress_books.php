            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <a href="?page=teacher/update_progress_books&child_id=<?= $child['id'] ?>" class="btn btn-primary">
    ...
    <div class="card-body">
        <form method="POST" action="<?= BASE_URL ?>public/index.php?page=update_progress_books">
            ...
            <div class="mt-4">
                ...
                <a href="<?= BASE_URL ?>public/index.php?page=<?= $_SESSION['role'] === 'superadmin' ? 'admin/classes' : 'teacher/class_students&class_id=' . $child['class_id'] ?>"
