...
<section class="pb-20">
    ...
    <form method="POST" action="<?= BASE_URL ?>public/index.php?page=update_progress_prayers"
        ...
        <div>
            ...
            <select name="prayer_id" id="prayer_id"
        ...
        <button type="submit"
            class="w-full bg-cyan-400 hover:bg-cyan-500 text-cyan-900 font-bold py-3.5 px-4 rounded-xl shadow-lg shadow-cyan-900/10 active:scale-95 transition-all flex items-center justify-center gap-2">
