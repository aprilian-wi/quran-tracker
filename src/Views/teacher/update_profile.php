...
<div class="row">
    <div class="col-md-8 offset-md-2">
        <div class="d-flex align-items-center mb-4">
            ...
            <h3 class="mb-0"><i class="bi bi-person-badge"></i> Profil Guru</h3>
        </div>

        <div class="card">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0"><i class="bi bi-person"></i> Informasi Guru</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <p><span class="badge bg-info fs-6">Guru</span></p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
        ...
        <div class="card mt-4">
            <div class="card-header bg-success text-white">
                <h5 class="mb-0"><i class="bi bi-house-door"></i> Kelas yang Diberikan</h5>
            </div>
            <div class="card-body">
                <?php
