                    ...
                    <?php if (hasRole('parent') || hasRole('teacher')): ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button"
                                data-bs-toggle="dropdown">Al-Qur'an</a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item"
                                        href="<?= BASE_URL ?>public/index.php?page=quran/surah_list">Daftar Surah</a></li>
                                <li><a class="dropdown-item"
                                        href="<?= BASE_URL ?>public/index.php?page=quran/search">Pencarian</a></li>
                                <li><a class="dropdown-item"
                                        href="<?= BASE_URL ?>public/index.php?page=quran/bookmarks">Penanda</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                                href="<?= BASE_URL ?>public/index.php?page=shared/list_short_prayers">Doa-doa Pendek</a>
                        </li>
                        <li class="nav-item">
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="<?= BASE_URL ?>public/index.php?page=logout">Keluar</a>
                            </li>
                        </ul>
                    </li>
                </ul>
