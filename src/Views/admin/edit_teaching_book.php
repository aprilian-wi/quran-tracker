...
<div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Edit Buku Ajar</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400">Edit teaching book volume</p>
        </div>
    </div>
    <a href="?page=admin/teaching_books"
...
<div class="max-w-2xl mx-auto">
    <div
        ...
        <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
            <h3 class="text-lg font-semibold text-slate-900 dark:text-white">Formulir Edit Buku</h3>
        </div>
        <div class="p-6">
            <form method="POST" action="?page=admin/update_teaching_book" class="space-y-6">
                <?= csrfInput() ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="volume_number" min="1" required value="<?= $book['volume_number'] ?>"
                    ...
                    <div>
                        ...
                        <input type="number" name="total_pages" min="1" required value="<?= $book['total_pages'] ?>"
                            class="block w-full rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-900 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                            placeholder="e.g. 40">
                ...
                <div
                    class="pt-4 flex items-center justify-end gap-3 border-t border-slate-200 dark:border-slate-700 mt-6">
                    <a href="?page=admin/teaching_books"
                        class="px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 transition-colors decoration-0">
                        Batal
                    </a>
                    <button type="submit"
