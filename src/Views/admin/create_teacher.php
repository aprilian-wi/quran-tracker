...
<div
    ...
    <form method="POST" action="<?= BASE_URL ?>public/index.php?page=create_teacher">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="name"
                        class="block w-full pl-10 rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-sm text-slate-900 dark:text-white focus:ring-primary focus:border-primary shadow-sm"
                        placeholder="Contoh: Ahmad S.Pd" required>
                </div>
            </div>
        ...
        <div class="flex items-center justify-end gap-3 mt-8 pt-6 border-t border-slate-100 dark:border-slate-700">
            ...
            <button type="submit"
                class="flex items-center justify-center px-4 py-2 bg-primary text-white rounded-lg text-sm font-medium hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors shadow-sm">
